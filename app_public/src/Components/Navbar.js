  ...
  return (
    <>
      <div className="navbar-topbar">
        <div className="navbar-topbar-phone"><a className="links" href="tel:9673766486">9673766486</a><a className="links" href="mailto:sweat4fit@gmail.com">sweat4fit@gmail.com</a></div>
        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul onClick={collapsenavbar} className="navbar-nav mb-2 mb-lg-0">
              ...
              <li className="nav-item">
                <Link className="nav-link" to="/ourtrainers">
                  Trainers
                </Link>
              </li>
              <li className="nav-item">
